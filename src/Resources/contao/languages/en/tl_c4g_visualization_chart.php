...
[
    ...
    'tooltips'          => ['Show tooltips', 'This can be used to disable the tooltips'],
    ...
    'cssClass'          => ['CSS class', 'Additional CSS class for custom styling. Use the class c4g-gantt as gantt example.'],
    ...
    'xLabelCountAll'    => ['Skip label for all values', 'Month to year e.g. 12'],
    'xTimeFormatAll'    => ['Time format for all values', 'Format string for the timestamp.'],
