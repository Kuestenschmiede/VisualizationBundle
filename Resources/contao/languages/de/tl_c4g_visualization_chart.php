...
[
    ...
    'imageMaxHeight'    => ['Maximale Bildhöhe (Pixel)', 'Das Seitenverhältnis wird beibehalten, die Bildhöhe kann also etwas kleiner ausfallen.'],
    'imageMaxWidth'     => ['Maximale Bildbreite (Pixel)', 'Das Seitenverhältnis wird beibehalten, die Bildbreite kann also etwas kleiner ausfallen.'],
    'imageMarginTop'    => ['Oberer Abstand', 'Oberer Abstand relativ zum oberen Rand der Grafik.'],
    'imageMarginLeft'   => ['Linker Abstand', 'Linker Abstand relativ zum linken Rand der Grafik.'],
    'imageOpacity'      => ['Bildtransparenz', 'Bildtransparenz in Prozent.'],
    'rangeWizard'       => ['Wertebereiche definieren', 'Jeder Wertebereich wird eigenständig angezeigt. Über Buttons kann zwischen den Wertebereichen gewechselt werden. Auf Kuchendiagramme haben Wertebereiche keinen Effekt.'],
