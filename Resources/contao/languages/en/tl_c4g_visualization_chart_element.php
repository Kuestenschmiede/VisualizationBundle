...
$GLOBALS['TL_LANG']['tl_c4g_visualization_chart_element'] = [
    ...
    'tablex2'           => ['End of range column', 'The column whose value is interpreted as the end value for the period (X axis).'],
    ...
    'periodWizard'      => ['Periods', 'Here the periods can be set (gantt).'],
    'fromX'             => ['Period begin', 'From this x value onward, the values are shown (inclusive).'],
    'toX'               => ['Period end', 'Up to this x value, the values are shown (inclusive).'],
    ...
    'redirectSite' => ['redirect page', 'When clicking on the element, should be redirected to the selected page.'],
    ...
    'option_period' => 'Periods (gantt)',
    'option_line' => 'Line',
    'option_spline' => 'Spline',
    'option_pie' => 'Pie',
    'option_donut' => 'Donut',
    'option_gauge' => 'Gauge',
    'option_bar' => 'Bar / Column',
    'option_gantt' => 'Gantt (timeline)'
];
